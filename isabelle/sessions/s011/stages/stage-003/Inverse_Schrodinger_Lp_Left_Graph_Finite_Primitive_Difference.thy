theory Inverse_Schrodinger_Lp_Left_Graph_Finite_Primitive_Difference
  imports
...
section \<open>Finite primitive-difference graph factorization\<close>

lemma slp_left_branch_complex_amplitude_finite_terminal_diff:
...
proof -
  note modulation =
    slp_left_branch_oscillatory_graph_kernel_fixed_root_finite_modulation[
      ...
      "slp_left_branch_complex_amplitude_finite root_weight cutoff potential
        ...
        slp_left_branch_complex_amplitude_finite root_weight cutoff potential
          ...
          primitive center *
            slp_left_branch_complex_amplitude_finite root_weight cutoff
              potential (\<lambda>_. 1) (\<lambda>_. 1) coordinates"
    by (rule slp_left_branch_complex_amplitude_finite_terminal_diff)
  show ?thesis
