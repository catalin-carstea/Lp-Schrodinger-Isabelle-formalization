theory Inverse_Schrodinger_Lp_Left_Graph_Finite_Primitive_Difference_Transport
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_003.Inverse_Schrodinger_Lp_Left_Graph_Finite_Primitive_Difference"
begin

section \<open>Fixed-root transport for the Cauchy primitive difference\<close>

context aim_planar_riesz_hls_cauchy
begin

theorem
    slp_left_branch_oscillatory_graph_kernel_fixed_root_finite_primitive_diff_integrable:
      ...
      "integrable
        ...
        integrable
          ...
          (slp_left_branch_oscillatory_graph_kernel_natural CARD('i) tau
            center cutoff potential
              (\<lambda>x. ?terminal x - ?terminal center) origin)"
    by (rule slp_left_branch_graph_natural_finite_integrable_iff[OF
