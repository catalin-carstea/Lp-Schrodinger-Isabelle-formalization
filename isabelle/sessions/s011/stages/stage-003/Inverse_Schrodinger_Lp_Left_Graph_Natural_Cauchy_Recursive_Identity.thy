theory Inverse_Schrodinger_Lp_Left_Graph_Natural_Cauchy_Recursive_Identity
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_003.Inverse_Schrodinger_Lp_Left_Graph_Natural_Cauchy_Integrable"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_002.Inverse_Schrodinger_Lp_Left_Graph_Natural_Nested_Identity_Integrable"
begin

section \<open>Cauchy-terminal natural graph as the recursive left branch\<close>

context aim_planar_riesz_hls_cauchy
begin

theorem slp_left_branch_oscillatory_graph_kernel_natural_integral_eq_nested_cauchy:
  ...
  shows
    "integral\<^sup>L
      ...
      slp_left_branch_nested_graph_functional n tau center cutoff potential
        (slp_cauchy_transform orientation potential) origin"
proof (rule
  ...
  show
    "integrable
      ...
      (slp_left_branch_oscillatory_graph_kernel_natural m tau center cutoff
        potential (slp_cauchy_transform orientation potential) root)"
    by (rule
...
theorem slp_left_branch_oscillatory_graph_kernel_natural_integral_eq_recursive_cauchy:
  fixes B C p tau :: real
    and center origin :: slp_point
    and cutoff potential :: "slp_point \<Rightarrow> complex"
    and orientation :: slp_cauchy_orientation
  ...
  by (rule
      slp_left_branch_oscillatory_graph_kernel_natural_integral_eq_nested_cauchy[
