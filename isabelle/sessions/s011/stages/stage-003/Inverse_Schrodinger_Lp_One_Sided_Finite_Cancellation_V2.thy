theory Inverse_Schrodinger_Lp_One_Sided_Finite_Cancellation_V2
  imports
...
section \<open>Source-exact finite left one-sided cancellation\<close>

definition slp_left_branch_finite_cancellation_model_v2 ::
...
where
  "slp_left_branch_finite_cancellation_model_v2 dimension_type tau
...
theorem slp_left_branch_finite_cancellation_model_v2_decay:
  ...
  shows
    "((\<lambda>tau. slp_left_branch_finite_cancellation_model_v2 TYPE('i) tau
