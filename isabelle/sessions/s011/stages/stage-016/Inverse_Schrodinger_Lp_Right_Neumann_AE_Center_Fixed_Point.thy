theory Inverse_Schrodinger_Lp_Right_Neumann_AE_Center_Fixed_Point
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Right_Neumann_Fixed_Point_Uniqueness"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_015.Inverse_Schrodinger_Lp_Oscillatory_Cauchy_Difference_AE"
begin

hide_const (open) Commutative_Ring.norm

section \<open>Almost-everywhere centers for the unique right Neumann fixed point\<close>

context slp_cauchy_local_w1s
begin

theorem slp_right_neumann_series_ae_center_fixed_point_unique:
    ...
    and unique_data:
      "\<forall>tau c candidate K.
        ...
        (AE z in lborel.
          candidate z =
            slp_right_neumann_series_sum X tau c cutoff coefficient z)"
    using slp_right_neumann_series_fixed_point_unique[
      OF riesz_hls cauchy_test_left_inverse evans_density
        exponent_lower exponent_upper loss_positive loss_upper
        radius_nonnegative radius_lower set_radius X_open X_bounded cutoff_test
        cutoff_bound cutoff_derivative_zero_bound
