theory Inverse_Schrodinger_Lp_Right_Neumann_Series_Fixed_Point
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Right_Neumann_Series_Esssup_Convergence"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Right_Neumann_Step_Difference"
begin

hide_const (open) Commutative_Ring.norm

section \<open>Literal right Neumann series as an almost-everywhere fixed point\<close>

context slp_cauchy_local_w1s
begin

lemma slp_right_neumann_step_restrict_input:
...
theorem slp_right_neumann_series_fixed_point:
    ...
    proof (intro allI impI)
      ...
      proof -
        ...
        have recurrence_eq: "?U (Suc j) = ?S (?U j)"
          ...
          apply (subst slp_right_neumann_step_restrict_input[
      ...
      have literal_fixed_point:
          "AE z in lborel. ?W z =
            slp_restrict_field X
              (slp_right_neumann_base tau c cutoff coefficient
                SLP_Partial_Inverse) z + ?S ?W z"
        using bridge(4)
        by (simp only: slp_right_neumann_series_sum_def
