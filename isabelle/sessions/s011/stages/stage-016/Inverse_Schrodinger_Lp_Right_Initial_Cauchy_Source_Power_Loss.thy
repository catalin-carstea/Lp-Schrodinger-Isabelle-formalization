theory Inverse_Schrodinger_Lp_Right_Initial_Cauchy_Source_Power_Loss
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Nested_Coefficient_Product_Right_Power_Loss_Esssup"
begin

hide_const (open) Commutative_Ring.norm

section \<open>Right initial Cauchy-source power-loss bound\<close>

context slp_cauchy_local_w1s
begin

theorem slp_right_initial_cauchy_source_esssup_power_loss_bound:
  ...
  proof (rule exI[of _ C], rule conjI[OF C_positive])
    ...
    proof (intro allI impI)
      ...
      have inner_cancel:
        ...
        unfolding slp_partial_psi_inverse_def phase_cancel ..
      have modulated_norm:
