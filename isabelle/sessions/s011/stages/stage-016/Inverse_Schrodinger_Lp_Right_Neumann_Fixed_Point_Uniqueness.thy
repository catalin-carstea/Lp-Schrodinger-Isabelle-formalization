theory Inverse_Schrodinger_Lp_Right_Neumann_Fixed_Point_Uniqueness
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_015.Inverse_Schrodinger_Lp_AE_Fixed_Point_Uniqueness"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Right_Neumann_Series_Fixed_Point"
begin

hide_const (open) Commutative_Ring.norm

section \<open>Uniqueness of the literal restricted right Neumann fixed point\<close>

context slp_cauchy_local_w1s
begin

lemma slp_right_neumann_series_ae_bounded:
...
proof -
  obtain C CV T :: real where C_positive: "0 < C"
    ...
    using slp_right_neumann_series_esssup_convergence[
...
theorem slp_right_neumann_series_fixed_point_unique:
  fixes p epsilon A R A0 B0 B1 :: real
    and X :: "slp_point set"
    and cutoff coefficient :: slp_scalar_field
  assumes riesz_hls: "aim_planar_riesz_hls_claim"
...
proof -
  obtain TB :: real where bounded_threshold_lower: "2 \<le> TB"
    and bounded_data:
      "\<forall>tau c.
        ...
        (\<exists>K::real. slp_ae_bounded_measurable lborel K
          (slp_right_neumann_series_sum X tau c cutoff coefficient))"
    using slp_right_neumann_series_ae_bounded[
      OF riesz_hls cauchy_test_left_inverse evans_density
        exponent_lower exponent_upper loss_positive loss_upper
        radius_nonnegative radius_lower set_radius X_open X_bounded cutoff_test
        cutoff_bound cutoff_derivative_zero_bound
        ...
        (AE z in lborel.
          slp_right_neumann_series_sum X tau c cutoff coefficient z =
            ...
            slp_restrict_field X
              (slp_right_neumann_step tau c cutoff coefficient
                (slp_right_neumann_series_sum X tau c cutoff coefficient)) z)"
    using slp_right_neumann_series_fixed_point[
      OF riesz_hls cauchy_test_left_inverse evans_density
        exponent_lower exponent_upper loss_positive loss_upper
        radius_nonnegative radius_lower set_radius X_open X_bounded cutoff_test
        cutoff_bound cutoff_derivative_zero_bound
  ...
  obtain TS :: real where step_threshold_lower: "2 \<le> TS"
    ...
    using slp_right_neumann_step_restricted_ae_contraction[
      OF riesz_hls cauchy_test_left_inverse evans_density
        exponent_lower exponent_upper loss_positive loss_upper
        radius_nonnegative radius_lower set_radius X_open X_bounded cutoff_test
        cutoff_bound cutoff_derivative_zero_bound
    ...
    proof (intro allI impI)
      ...
      proof -
        ...
        have difference_eq:
          ...
          by (rule slp_right_neumann_step_restricted_difference[
