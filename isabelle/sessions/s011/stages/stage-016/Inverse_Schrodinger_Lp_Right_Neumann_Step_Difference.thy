theory Inverse_Schrodinger_Lp_Right_Neumann_Step_Difference
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_016.Inverse_Schrodinger_Lp_Right_Neumann_Step_AE_Contraction"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_015.Inverse_Schrodinger_Lp_Nested_Coefficient_Difference_Pointwise"
begin

hide_const (open) Commutative_Ring.norm

section \<open>Difference law for the literal restricted right step\<close>

context slp_cauchy_local_w1s
begin

theorem slp_right_neumann_step_restricted_difference:
  fixes p K L :: real
    and X :: "slp_point set"
  ...
  shows
    "slp_restrict_field X
      ...
      (\<lambda>z.
        slp_restrict_field X
            (slp_right_neumann_step tau c cutoff coefficient f) z -
          slp_restrict_field X
            (slp_right_neumann_step tau c cutoff coefficient g) z)"
proof -
  have p_positive: "0 < p"
