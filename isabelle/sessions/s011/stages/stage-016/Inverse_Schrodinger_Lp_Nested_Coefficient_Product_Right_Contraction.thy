theory Inverse_Schrodinger_Lp_Nested_Coefficient_Product_Right_Contraction
  imports
...
section \<open>Concrete right center-uniform contraction threshold\<close>

context slp_cauchy_local_w1s
begin

theorem slp_nested_coefficient_product_right_esssup_contraction:
