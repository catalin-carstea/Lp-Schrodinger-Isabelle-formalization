theory Inverse_Schrodinger_Lp_Right_One_Sided_Finite_L2_Error_Decay
  imports
...
section \<open>Direct right residual-frequency-parametric finite L2 error decay\<close>

context aim_planar_riesz_hls
begin

theorem slp_right_branch_finite_oscillatory_l2_error_decay_indexed_frequency:
  ...
  shows
    "((\<lambda>i.
        slp_right_branch_finite_oscillatory_integral TYPE('i) (frequency i)
...
proof -
  ...
  proof eventually_elim
    ...
    show "ennreal (Real_Vector_Spaces.norm (?I i)) \<le> ?pairing i"
      unfolding slp_left_one_sided_output_density_def
    proof (rule
        slp_right_branch_finite_oscillatory_integral_unit_terminal_bound[
          ...
          unfolded slp_right_one_sided_output_density_def])
...
proof -
  ...
  show ?thesis
    by (rule
        slp_right_branch_finite_oscillatory_l2_error_decay_indexed_frequency[
