theory Inverse_Schrodinger_Lp_Right_Born_Finite_Cancellation
  imports
...
section \<open>Identification of the finite right Born term with cancellation\<close>

context aim_planar_riesz_hls_cauchy
begin

theorem slp_right_born_functional_eq_finite_cancellation_model:
...
proof -
  ...
  have born_evaluated:
    ...
    by (rule slp_right_born_functional_eq_finite_center_cauchy_pair_lp_root[
  ...
  have cancellation_evaluated:
    ...
    by (rule
      slp_right_branch_finite_cancellation_model_eq_evaluated_pair_lp_root[
        where B = B and C = C and p = p and X = X,
