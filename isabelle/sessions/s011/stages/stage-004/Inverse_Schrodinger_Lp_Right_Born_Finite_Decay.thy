theory Inverse_Schrodinger_Lp_Right_Born_Finite_Decay
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_004.Inverse_Schrodinger_Lp_Right_Born_Finite_Cancellation"
    "Paper_Inverse_Schrodinger_Lp_Proof_Stage_004.Inverse_Schrodinger_Lp_Right_One_Sided_Finite_Cancellation_Decay"
begin

section \<open>Decay of each finite right Born term\<close>

context aim_planar_riesz_hls_cauchy
begin

theorem slp_right_born_functional_finite_decay:
  ...
  have cancellation_decay:
      "((\<lambda>tau.
          slp_right_branch_finite_cancellation_model TYPE('i) tau potential
            cutoff potential ?terminal phi)
        \<longlongrightarrow> 0) at_top"
    by (rule slp_right_branch_finite_cancellation_model_decay[
          where B = B and C = C and p = p and X = X,
