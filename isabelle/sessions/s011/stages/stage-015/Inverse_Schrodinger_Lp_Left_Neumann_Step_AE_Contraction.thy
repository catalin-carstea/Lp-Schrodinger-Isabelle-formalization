theory Inverse_Schrodinger_Lp_Left_Neumann_Step_AE_Contraction
  imports
...
section \<open>Literal left Neumann step on AE-bounded measurable fields\<close>

context slp_cauchy_local_w1s
begin

theorem slp_left_neumann_step_restricted_ae_contraction:
