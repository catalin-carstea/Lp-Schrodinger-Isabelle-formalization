theory Inverse_Schrodinger_Lp_Left_Neumann_Series_Esssup_Convergence
  imports
...
section \<open>Literal left Neumann series in raw essential-supremum form\<close>

definition slp_left_neumann_series_sum ::
...
theorem slp_left_neumann_series_esssup_convergence:
    ...
    proof (intro allI impI)
      ...
      have series_measurable:
          "slp_left_neumann_series_sum X tau c cutoff coefficient
            \<in> borel_measurable lborel"
        using series(1)
        unfolding slp_left_neumann_series_sum_def by simp
      have norm_summable:
          "AE z in lborel.
