theory Inverse_Schrodinger_Lp_Born_All_Order_Terminal_Weighted_Pairing
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof.Inverse_Schrodinger_Lp_Born_All_Order_Terminal_Weighted"
    "Paper_Inverse_Schrodinger_Lp_Proof.Inverse_Schrodinger_Lp_Positive_Ennreal_Complex_Pairing_Bound"
begin

section \<open>Uniform output pairings for terminal-weighted branches\<close>

context aim_planar_riesz_hls
begin

theorem slp_positive_output_density_all_orders_terminal_weighted_pairing_uniform:
  fixes R C p :: real
