theory Inverse_Schrodinger_Lp_Positive_Inner_Mass_Terminal_Weighted_Cutoff
  imports
...
section \<open>Uniform cutoff-local terminal-weighted finite inner mass\<close>

context aim_planar_riesz_hls
begin

theorem slp_left_branch_positive_inner_mass_terminal_weighted_cutoff_uniform:
