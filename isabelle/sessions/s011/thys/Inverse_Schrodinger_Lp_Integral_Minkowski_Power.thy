theory Inverse_Schrodinger_Lp_Integral_Minkowski_Power
  imports Inverse_Schrodinger_Lp_Weighted_Holder_Power
begin

section \<open>Integral Minkowski power bound\<close>

lemma slp_integral_minkowski_power_plane:
...
proof -
  ...
  have datum_section_measurable:
      "(datum t) \<in> borel_measurable lborel"
    for t
    by measurable
