theory Inverse_Schrodinger_Lp_Positive_Amplitude_Terminal_Weighted
  imports
    "Paper_Inverse_Schrodinger_Lp_Proof.Inverse_Schrodinger_Lp_Positive_Inner_Mass_Terminal_Weighted"
    "Paper_Inverse_Schrodinger_Lp_Proof.Inverse_Schrodinger_Lp_One_Sided_Finite_Positive_Inner_Mass"
begin

section \<open>Terminal-weighted packed positive-amplitude finiteness\<close>

context aim_planar_riesz_hls
begin

theorem slp_left_branch_positive_amplitude_packed_terminal_weighted_lt_top:
...
proof -
  ...
  have inner_mass_uniform:
    ...
    by (rule slp_left_branch_positive_inner_mass_terminal_weighted_uniform[
          OF radius_nonnegative p_lower p_upper cutoff_measurable potential_lp
            cutoff_bound C_nonnegative terminal_value_measurable terminal_value_le
            output_factor_lp])
  show ?thesis
